        ...
        <View style={[styles.lockedOverlay, { backgroundColor: colors.background }]}>
          <View style={[styles.lockedCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
            <View style={styles.lockIconWrap}>
              <Feather name="folder" size={28} color="#C9A227" />
            </View>
            <Text style={[styles.lockedTitle, { color: colors.foreground }]}>Evidence Vault is Premium</Text>
            <Text style={[styles.lockedSub, { color: colors.mutedForeground }]}>
              Store photos, documents, receipts and notes for your case. Subscribe to unlock all features.
            </Text>
            <Pressable
              onPress={() => {
